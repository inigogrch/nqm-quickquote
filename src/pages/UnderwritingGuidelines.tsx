      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <section id="non-qm-programs" className="mb-16 scroll-mt-20">
          ...
          <div id="flex-select-overview" className="scroll-mt-20 mb-12 mt-16">
            <h3 className="text-2xl font-semibold mb-4">Flex Select Overview</h3>
            <p className="text-sm leading-relaxed mb-6">
              The Flex Select Program is designed to cover the widest range of income documentation types,
              housing history, and other program specific options. Refer to the Flex Select Matrix for specific
              program requirements.
            </p>

            {/* Flex Select - General Requirements */}
            <div id="flex-select-general-requirements" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - General Requirements</h4>
              ...
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50 w-1/4">Exceptions</td>
                      <td className="px-6 py-4 text-muted-foreground">Eligible except for P&L Only and Express DU</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Product Type</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-1">
                          ...
                          <li>5/6 SOFR ARM I/O, 30 Year Term and 40 Year Term</li>
                          <li>40 Year products and terms are ineligible for Manufactured Housing</li>
                          <li>I/O products are ineligible for Express (DU)</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Interest Only (I/O)</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-1">
                    ...
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-1">
                          ...
                          <li>Loan Amounts $125,000 - $149,999 require a 5% reduction in LTV</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          ...
                          <li>Lender Paid or 3rd Party Buydowns are eligible for Correspondent Clients only</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Occupancy</td>
                      <td className="px-6 py-4 text-muted-foreground">Primary Residence, Second Home, and Investment Property</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Loan Purpose</td>
                      <td className="px-6 py-4 text-muted-foreground">Purchase, Rate & Term Refinance, Cash Out Refinance, and Debt Consolidation</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Cash-Out</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Minimum of six (6) months seasoning from most recent transaction.</li>
                          <li>Max cash-out (defined as cash in hand):
                            <ul className="list-circle pl-6 mt-1 space-y-1">
                              <li>If LTV &le; 60% = Unlimited</li>
                              <li>If LTV &gt; 60% = Max $1,000,000 or unlimited with 18 months reserves exclusive of cash back</li>
                            </ul>
                          </li>
                          <li>Condos: Max 75% LTV</li>
                          <li>Condotel: See Condotels below for LTV limitations.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Interested Party Contributions</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <p className="mb-2"><span className="font-medium">Primary Residence and Second Homes:</span></p>
                        <ul className="list-disc pl-5 space-y-1 mb-3">
                          <li>&le; 75% LTV = 9%</li>
                          <li>&gt; 75% = 6%</li>
                        </ul>
                        <p className="mb-2"><span className="font-medium">Investment:</span></p>
                        <ul className="list-disc pl-5 space-y-1">
                          <li>6%</li>
                        </ul>
                      </td>
                    ...
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Subordinate Financing</td>
                      <td className="px-6 py-4 text-muted-foreground">Eligible on Primary Residence and Second Homes only</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Escrow Waivers</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <p className="mb-2">Waiving escrows is permitted as follows:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>O/O and 2nd Homes: 680 Minimum Score up to 80% LTV</li>
                          <li>Investment Properties: 660 Minimum Score up to 80% LTV</li>
                          <li>CA: with a Minimum score of 700, waiver is permitted up to 90% LTV</li>
                    ...
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-1">
                          <li>Required on Investment Properties when permitted. See the "Business Purpose Licensing & PPP Restrictions" PDF in the Documents Tab in the Client Portal.</li>
            ...
            <div id="flex-select-borrower-eligibility" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - Borrower Eligibility</h4>
              ...
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-4">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-1">
                          ...
                          <li>No Cash-Out Refi; Rate & Term Refinance (non-occupant must be on current loan)</li>
                          <li>Non-occupant co-borrower must be a relative</li>
                          <li>Max Loan Amount $1,000,000</li>
                        </ul>
                      </td>
                    ...
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">First Time Homebuyer (FTHB)</td>
                      <td className="px-6 py-4 text-muted-foreground">Eligible to a max loan size of $1,500,000 on Primary Residence, Second Homes, and Investment Properties</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div id="flex-select-credit-requirements" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - Credit Requirements</h4>
                ...
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          ...
                          <li>The Representative Score is based on the primary wage earners credit score, qualify as follows:
                            <ul className="list-circle pl-6 mt-1 space-y-1">
                              <li>Middle of 3 credit scores or lower of 2 credit scores</li>
                              <li>When qualifying income is equal for all borrowers on the loan, the highest representative score will be used.</li>
                            </ul>
                          </li>
                          <li>Additional borrowers must have a minimum credit score of 600</li>
                          <li>P&L Only: all borrowers must have a minimum credit score of 700</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                    ...
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>1x30x12 maximum delinquency permitted per the matrix</li>
                          <li>3x30x12 will be considered as follows:
                            <ul className="list-circle pl-6 mt-1 space-y-1">
                              <li>Borrower must be 0x30 in the most recent 6 months</li>
                    ...
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Credit and Housing Event Seasoning</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <div className="overflow-x-auto">
                          <table className="w-full border border-gray-300 text-sm mt-2">
                            <thead>
                              <tr className="bg-gray-100">
                                <th className="px-4 py-2 border border-gray-300 text-left font-semibold">BK/FC/SS/DIL/Mod</th>
                                <th className="px-4 py-2 border border-gray-300 text-left font-semibold">&ge;4 Years</th>
                                <th className="px-4 py-2 border border-gray-300 text-left font-semibold">&ge; 3 Years</th>
                                <th className="px-4 py-2 border border-gray-300 text-left font-semibold">&ge; 2 Years</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td className="px-4 py-2 border border-gray-300 font-medium">Max LTV/CLTV</td>
                              ...
                              <tr>
                                <td className="px-4 py-2 border border-gray-300 font-medium">Max LTV Cash Out</td>
                                <td className="px-4 py-2 border border-gray-300">80%</td>
                                <td className="px-4 py-2 border border-gray-300">75%</td>
                                <td className="px-4 py-2 border border-gray-300">70%</td>
                              </tr>
                              <tr>
                                <td className="px-4 py-2 border border-gray-300 font-medium">Max Loan Amount</td>
                                <td className="px-4 py-2 border border-gray-300">$3,500,000</td>
                                <td className="px-4 py-2 border border-gray-300">$3,000,000</td>
                                <td className="px-4 py-2 border border-gray-300">$2,000,000</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
            ...
            <div id="flex-select-dti-residual" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - DTI and Residual Income Requirements</h4>
              
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50 w-1/4">DTI Requirements</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Max 50%</li>
                          <li>40 Year Fixed Must Qualify as a 30 Year at &le; 55% DTI.</li>
                          <li>55% DTI (&gt;50% to 55%) with the following restrictions:
                            <ul className="list-circle pl-6 mt-1 space-y-1">
                              ...
                              <li>4 years seasoning for housing events required</li>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Minimum monthly residual income of $3,500 is required.</li>
                          <li>Applies to HPML loans or when the DTI &gt; 43% on Primary Residence and Second Homes only</li>
                          <li>Defined as Gross Monthly Income less Total Monthly Obligations</li>
                          <li>Requirement based on # in household:
                            <ul className="list-circle pl-6 mt-1 space-y-1">
            ...
            <div id="flex-select-income" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - Income Requirements</h4>
              
              <h5 className="font-semibold text-md mb-3 mt-6">General Requirements</h5>
              
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50 w-1/4">Self-Employment History</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <p className="mb-3">Self-employment history of &gt;=2 years is required. If self-employment history is &lt; 2 years:</p>
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Self-employment 18+ months with 3+years prior experience in the same line of business</li>
                          <li>Self-employed borrowers in a licensed profession (i.e., Medical, Legal, Accounting) will be considered from a business that has been in existence for less than two (2) years, but greater than one (1) year provided the borrower meets the following requirements:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>Borrower has at least three (3) years of documented previous experience in the same profession, or</li>
                              <li>Evidence of formal education in a related field</li>
                            </ul>
                          </li>
                        </ul>
                        <p className="mb-2">For both options above, the following restrictions apply:</p>
                        <ul className="list-disc pl-5 space-y-1">
                          <li>Minimum credit score: 700</li>
                          <li>Max LTV: 80% Primary Residence / 75% Second Home / 70% Investment Properties</li>
                        </ul>
                      </td>
                    </tr>
                  </tbody>
              ...
              <h5 className="font-semibold text-md mb-3 mt-6">Full Documentation</h5>
              ...
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    ...
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Self-Employment</td>
                      <td className="px-6 py-4 text-muted-foreground">1 or 2 years of personal and business Tax Returns, YTD P&L, Tax Transcripts, 2 months of most recent bank statements to support the income on the P&L</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Rental Income</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <p className="mb-3 font-medium">Rental income on the Tax Returns:</p>
                        <ul className="list-disc pl-5 space-y-2 mb-4">
                          <li>When tax returns are used to qualify, an average of 2 years of rental income will be used unless the income is declining in which case the most recent years' income will be used for qualifying</li>
                          <li>Cash flow Analysis of the Schedule E should be completed</li>
                        </ul>
                        <p className="mb-3 font-medium">Rental Income NOT on Tax Returns:</p>
                        <ul className="list-disc pl-5 space-y-2 mb-4">
                          <li>Evidence of borrower's ownership of the property</li>
                          <li>For a refinance and/or to document rental income on other REOs:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                        ...
                        <p className="mb-3 font-medium">Rental Income from a Departing Residence:</p>
                        <ul className="list-disc pl-5 space-y-2 mb-4">
                          <li>75% of the rental amount on the lease if used for qualifying.</li>
                          <li>Evidence the rental amount is at market rate, which can be documented through an online source or a 1007.</li>
                        </ul>
                        <p className="mb-3 font-medium">Short Term Gross Rental Income:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>12-month look back on rents received using bank statements or</li>
                          <li>Third party rental statements</li>
                        </ul>
                  ...
                  <tbody>
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>12 or 24 months of personal and 2 months of business bank statements</li>
                          <li>Qualifying income is determined by the total eligible deposits from the 24 or 12 months of personal statements divided by the number of statements</li>
                          <li>The business bank statements must reflect business activity and transfers to the personal account</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Business/Co-Mingled Bank Statements</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <p className="mb-3">12 or 24 months of business bank statements. Qualifying income is determined by ONE of the following analysis methods:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Fixed Expense Ratio (50%); OR</li>
                          <li>Expense ratio provided by a 3rd party (CPA/EA or PTIN tax preparer), min ratio of 20%, OR</li>
                          <li>3rd party prepared Profit &amp; Loss Statement (CPA/EA or PTIN tax preparer), min ratio of 20%</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">P&L Plus 2 Months Bank Statements</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Max 80% LTV</li>
                          <li>12 or 24 months P&L; prepared by CPA/EA or PTIN tax preparer</li>
                          <li>CPA/EA or PTIN tax preparer must also attest to having prepared the borrower's most recent tax returns</li>
                          <li>Qualifying income is the monthly net income from the P&L divided by the number of months covered by the P&L.</li>
                        </ul>
                        <p className="mb-3">When evaluating the P&L, the expenses are expected to be at least 20% of gross revenue. In the event less than 20% is reflected in expenses, the net income will be adjusted to reflect a 20% expense level when qualifying.</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Depreciation, depletion and amortization/casualty losses listed on the P&L may be added back to the applicant's income</li>
                          <li>Minimum of 2 months business bank statements</li>
                          <li>The monthly gross revenue on the P&L must be supported by the bank statements</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">P&L Only</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Exceptions are ineligible.</li>
                          <li>Ineligible for borrowers with less than 2 years in the current business</li>
                          <li>Max Loan Amount $1,500,000</li>
                          <li>700+ credit score required for all borrowers</li>
                          <li>Max LTV is the lesser of the LTV on the Program Matrix or:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Qualifying income is the monthly net income from the P&L divided by the number of months covered by the P&L.</li>
                          <li>Depreciation, depletion and amortization/casualty losses listed on the P&L may be added back to the applicant's income</li>
                          <li>Verbal verification of P&L is required on wholesale transactions.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">IRS Form 1099</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>1 or 2 years IRS Form 1099</li>
                          <li>Fixed Expense Ratio of 10%</li>
                          <li>YTD Documentation to support continued receipt of income from same source, is required only when the most recent 1099 is &gt;90 days from the note date</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">WVOE</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Maximum loan amount $1,500,000</li>
                          <li>Minimum credit score 680 for Primary Residence max 80% LTV; Second Home and Investment Property max 75% LTV</li>
                          <li>0x30x12 housing history is required; borrowers without a housing history are ineligible</li>
                          <li>Family members or related individuals may not employ borrowers</li>
                          <li>W2s, Tax Returns, Paystubs, 4506-C are not required</li>
                        </ul>
                        <p className="mb-3">Written Verification of Employment (WVOE) – FNMA 1005 completed with the past 2 years of income/employment. Form must be completed by Human Resources, Payroll, or an Officer of the Company:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Two (2) most recent months of bank statements supporting at least 65% of the gross wages reflected in the WVOE</li>
                          <li>Verification of delivery and receipt of the FNMA Form 1005 required</li>
                          <li>One-year history with the same employer with a minimum of two (2) years in the same line of work.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Asset Utilization</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Qualified Assets must be seasoned for 3 months.</li>
                          <li>Purchase/Rate &amp; Term Refinance:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>&gt; 85% LTV permitted per the matrix when the DTI is &lt;=60% without using assets for income</li>
                            </ul>
                          </li>
                          <li>Cash-Out: follow LTV limits per matrix.</li>
                        </ul>
                        <p className="mb-2 font-medium">Monthly Income Calculation:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>When the DTI without asset utilization is &lt;= 60%:
            ...
            <div id="flex-select-assets" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - Asset and Reserve Requirements</h4>
              ...
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          ...
                          <li>Large deposits (&gt; 50% of gross income) must be documented on purchase transactions</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Reserves</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>&lt;= $500,000 = 3 months PITIA w/LTV &lt;= 80%</li>
                          <li>&lt;= $500,000 = 6 months PITIA w/LTV &gt; 80%</li>
                          <li>&gt; $500,000 to $1,500,000 = 6 months PITIA</li>
                          <li>&gt; $1,500,000 to $2,500,000 = 9 months PITIA</li>
                          <li>&gt; $2,500,000 to $3,500,000 = 12 months PITIA</li>
                          <li>Cash Out proceeds may be used to satisfy reserves</li>
                          <li>When Asset Utilization is the sole source of income, reserves are not required</li>
                        </ul>
                      </td>
                    ...
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Gift Funds</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Gift funds are eligible provided borrower meets minimum contribution:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>5% primary</li>
                              <li>10% Second Home and Investment Properties</li>
                            </ul>
                          </li>
                          <li>100% Gift Funds may be used for down payment and closing cost for Primary Residence and Second Home when the LTV U.S. &lt;= to 80%</li>
                          <li>Investment Properties, gift funds are eligible after meeting the minimum 10% borrower contribution regardless of LTV</li>
                          <li>Gift funds are ineligible for reserves</li>
                          <li>Gift of Equity is eligible for Primary Residence only</li>
                        </ul>
                      </td>
                    </tr>
                  </tbody>
            ...
            <div id="flex-select-property" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - Property Requirements</h4>
              
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50 w-1/4">Single Family, PUD, Townhouse (Attached/Detached)</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Single Family residences with 1 or more accessory dwelling units (ADU) are eligible if subject property is in a municipality that allows.</li>
                          <li>The Appraiser must specifically confirm compliance with local regulations and provide 2 similar comparables.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">2-4 Units</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Max LTV is the lesser of the Matrix LTV 85%</li>
                          <li>2-4 units with 1 ADU are eligible if subject property is in a municipality that allows.</li>
                          <li>The Appraiser must specifically confirm compliance with local regulations and provide 2 similar comparables.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Condominium (Warrantable)</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Warrantable / Non-Warrantable:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>Purchase &amp; Rate &amp; Term Refinance: Max 85% LTV</li>
                              <li>Cash Out: 75% LTV</li>
                            </ul>
                          </li>
                          <li>Limited Review Established Condos Outside of Florida LTV/CLTV Limits where the building has 5+ units:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>Primary Residence 85%</li>
                              <li>Second home and Investment Property 75%</li>
                            </ul>
                          </li>
                          <li>Limited Review Established Condos in Florida (Warrantable) LTV/CLTV Limits:
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>Primary residence 75%/90%</li>
                              <li>Second home and Investment Properties: 70%/75%</li>
                            </ul>
                          </li>
                    ...
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Condotel</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <div className="mb-3">
                          <p className="font-medium mb-2">Primary Residence</p>
                          <ul className="list-disc pl-5 space-y-1">
                            <li>Purchase or Rate &amp; Term Refinance:
                              <ul className="list-disc pl-5 mt-1">
                        ...
                        <div className="mb-3">
                          <p className="font-medium mb-2">Second Home &amp; Investment Property</p>
                          <ul className="list-disc pl-5 space-y-1">
                            <li>Purchase or Rate &amp; Term Refinance:
                              <ul className="list-disc pl-5 mt-1">
                                <li>700+ credit score; lesser of Matrix LTV or Max 75%LTV</li>
                                <li>680-699 credit score; lesser of Matrix LTV or Max 70% LTV</li>
                              </ul>
                            </li>
                            <li>Cash Out Refinance:
                              <ul className="list-disc pl-5 mt-1">
                                <li>700+ credit score; lesser of Matrix LTV or Max 65% LTV</li>
                                <li>680-699 credit score; lesser of Matrix LTV or Max 60% LTV</li>
                              </ul>
                            </li>
                          </ul>
                        </div>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Must have a full kitchen &amp; a separate bedroom.</li>
                          <li>Must be in a resort area or affiliated with a national hotel chain</li>
                          <li>Max Loan Amount $1,500,000</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Co-ops</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Eligible for the Delegated Correspondent Channel ONLY</li>
                          <li>Correspondent Clients must use their own Closing Plan Codes</li>
                          <li>Available in New York City - 5 Boroughs ONLY: Bronx, Brooklyn, Manhattan, Queens &amp; Staten Island</li>
                          <li>Max 80% LTV</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Manufactured Housing</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Eligible for the Delegated Correspondent Channel ONLY</li>
                          <li>Correspondent Clients must use their own Closing Plan Codes.</li>
                        ...
                        <ul className="list-disc pl-5 space-y-2 mb-3">
                          <li>Min 20' wide (Double-wide), min 750+ sq ft, must meet "HUD Code" including being built on a permanent chassis, installed on a permanent foundation, and title as real estate</li>
                          <li>May not be older than 15 years</li>
                          <li>May not be if in need of repairs (as per the appraisal) of more than 5% of the property value</li>
                        </ul>
                        <p className="font-medium mb-2">Eligible Transactions:</p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Cash Out is ineligible, Primary Residence and Second Home only, minimum credit score 680, Max 80% LTV</li>
                          <li>Investment property and Interest Only loans are ineligible</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Rural Properties</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Rural properties are eligible for Primary Residence up to 80% LTV; max 20 acres</li>
                          <li>Second home and Investment Properties may be considered when the subject has &lt;= 2 acres up to a max LTV of 75%</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Appraisals</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Second appraisal required for loans &gt; $2,000,000</li>
                          <li>Appraisal Review Product to be ordered on all loans with a FNMA SSR over 2.5, except for those with a full second appraisal</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Declining Markets</td>
                      <td className="px-6 py-4 text-muted-foreground">As identified by the appraiser, require a 5% LTV reduction off the matrix when &gt; 65% LTV</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Acreage</td>
                      <td className="px-6 py-4 text-muted-foreground">Max 20 acres Primary Residence &amp; Second Home; max 5 acres Investment Properties</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div id="flex-select-express" className="mb-8 scroll-mt-20">
              <h4 className="text-lg font-semibold mb-4 text-gray-900">Flex Select - Express (DU) Requirements</h4>
              
              <p className="text-sm mb-4 text-muted-foreground">Follow Flex Select where silent in this section.</p>
              
              <div className="rounded-lg border border-border bg-card overflow-hidden shadow-sm mb-6">
                <table className="w-full text-sm border-collapse">
                  <tbody>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50 w-1/4">Express (DU) Underwriting Method</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>FNMA DU only</li>
                          <li>Ineligible for ITIN, P&L Only and less than 2 years of self-employment history in the same business.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">DU Findings</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Eligible DU Findings – Approve/Eligible and Approve/Ineligible.
                            <ul className="list-disc pl-5 mt-2 space-y-1">
                              <li>Ineligible results are only eligible for items such as loan size, LTV limits, loan purpose or feature.</li>
                              <li>DU cannot be ineligible for a credit event or due to risk factors.</li>
                            </ul>
                          </li>
                          <li>Credit score used to qualify is the credit score from the primary borrower.</li>
                          <li>Extenuating circumstances for derogatory credit are ineligible, i.e., cannot instruct DU to disregard information on credit report(s) to receive an Approve/Eligible.</li>
                          <li>Seller negotiated criteria/variances with FNMA are ineligible.</li>
                          <li>Non-Delegated Correspondents are responsible for providing the DU Findings with the loan submission and must match to the final terms of the loan.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">LTV/Score Eligibility</td>
                      <td className="px-6 py-4 text-muted-foreground">740-759 credit scores are ineligible for loans with LTV &gt; 85%; follow standard program requirements</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Max Loan Amount & LTV</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Max Loan Amount = $2,000,000</li>
                          <li>Max LTV = 90% LTV (minimum 760 credit score for LTVs &gt; 85%)</li>
                          <li>&gt; 85% LTV = Max loan amount is $1,500,000</li>
                          <li>First time homebuyer max loan amount $1,500,000</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                    ...
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Exceptions</td>
                      <td className="px-6 py-4 text-muted-foreground">Ineligible</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">ITIN</td>
                      <td className="px-6 py-4 text-muted-foreground">Ineligible</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Non-Occupant Co-Borrower</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Primary Residence only</li>
                          <li>Purchase and Rate &amp; Term Refinance only (non-occupant must be on the current mortgage for a Rate &amp; Term Refinance refinance)</li>
                          <li>Non-occupant co-borrower must be a relative</li>
                          <li>Max 90% LTV</li>
                          <li>The occupying borrower and non-occupant co-borrower ratios may be blended to a max of 50% DTI</li>
                          <li>Max loan amount $1,000,000</li>
                          <li>Use the primary borrower's credit score, whether it be the occupant or the non-occupying co-borrower</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Credit/Housing Events</td>
                      <td className="px-6 py-4 text-muted-foreground">Follow AUS except for housing history must be 0x30x12 and no extenuating circumstances for Bankruptcy or Housing Event</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Housing History</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>0x30x12</li>
                          <li>DU may waive the requirements for rental history on certain DU casefiles; documentation is still required to support a 0x30x12 history. It is permissible to allow the waiver of canceled checks for private party VORs when eligible per DU.</li>
                        </ul>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Income</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>Max DTI: 50%</li>
                          <li>Follow program documentation requirements</li>
                          <li>Follow program DTI restrictions</li>
                          <li>Transcripts required for the number of years of income used to qualify on Full Doc loans</li>
                    ...
                    <tr className="border-b border-border">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
                          <li>LTVs &gt; 85%:
                            <ul className="list-disc pl-5 mt-1">
                              <li>Up to $1,500,000 with 760+ credit score = 6 months PITIA</li>
                            </ul>
                          </li>
                          <li>LTV &lt;= 85%:
                            <ul className="list-disc pl-5 mt-1">
                              <li>Loans &lt;= $2,000,000 follow DU Findings</li>
                              <li>Loans &gt; $2,000,000 must meet product reserve requirements</li>
                            </ul>
                          </li>
                        </ul>
                      </td>
                    ...
                    <tr>
                      <td className="px-6 py-4 font-semibold text-foreground bg-muted/50">Appraisal</td>
                      <td className="px-6 py-4 text-muted-foreground">
                        <ul className="list-disc pl-5 space-y-2">
          ...
          {/* TODO: Add remaining programs (Select ITIN, Super Jumbo, Second Lien Select, Foreign National) */}
          <div className="mt-12 p-6 bg-muted/30 rounded-lg border border-border">
            <p className="text-sm text-muted-foreground italic text-center">
              Additional programs (Select ITIN, Super Jumbo, Second Lien Select, Foreign National) to be added...
            </p>
          </div>
